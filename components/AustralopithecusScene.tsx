...
const choices: Choice[] = [
  ...
  {
    id: "quedarse-expuesto",
    correct: false,
    label: "Quedarse expuesto",
    x: 66.4,
    y: 80.4,
    w: 29.1,
    h: 11.3,
...
export default function AustralopithecusScene() {
...
function GameFrame({
  ...
  const imageSrc =
    screen === "victory"
      ? "/assets/australopithecus-victory.png"
      : screen === "fail"
        ? "/assets/australopithecus-fail.png"
        : "/assets/australopithecus-game.png";
  ...
  return (
    ...
    >
      <div className="relative aspect-[1792/1024] h-auto w-full max-h-screen max-w-screen overflow-hidden">
        <img
          src={imageSrc}
          alt="Desafío visual de Australopithecus afarensis"
        ...
        {screen === "playing" && (
          <>
            <div className="pointer-events-none absolute left-[72.4%] top-[3.4%] flex -translate-x-1/2 items-center gap-[2vw]">
              <HudValue
                color="orange"
