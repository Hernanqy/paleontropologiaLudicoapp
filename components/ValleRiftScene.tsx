...
const choices: Choice[] = [
  {
    id: "moverse-ambientes",
    correct: true,
    label: "Moverse entre ambientes",
    x: 5.3,
    y: 68.4,
    w: 29.3,
    h: 10.7,
  ...
  {
    id: "observar-horizonte",
    correct: true,
    label: "Observar el horizonte",
    x: 35.5,
    y: 68.4,
    w: 29.3,
    h: 10.7,
  ...
  },
  {
    id: "depender-recurso",
    correct: false,
    label: "Depender de un solo recurso",
    x: 35.5,
    y: 82.3,
    w: 29.3,
    h: 10.7,
...
export default function ValleRiftScene() {
...
function GameFrame({
  ...
  const imageSrc =
    screen === "victory"
      ? "/assets/valle-rift-victory.png"
      : screen === "fail"
        ? "/assets/valle-rift-fail.png"
        : "/assets/valle-rift-game.png";
  ...
  return (
    ...
    >
      <div className="relative aspect-[1792/1024] h-auto w-full max-h-screen max-w-screen overflow-hidden">
        <img
          src={imageSrc}
          alt="Desafío visual del Valle del Rift"
        ...
        {screen === "playing" && (
          <>
            <div className="pointer-events-none absolute right-[9.2%] top-[4.2%] flex items-center gap-[1.6vw]">
              <HudValue
                color="orange"
