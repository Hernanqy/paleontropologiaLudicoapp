...
const choices: Choice[] = [
  ...
  {
    id: "compartir-aprendizaje",
    correct: true,
    label: "Compartir aprendizaje",
    x: 34.6,
    y: 68.5,
    w: 29.4,
    h: 10.8,
  ...
  {
    id: "esperar-sin-probar",
    correct: false,
    label: "Esperar sin probar",
    x: 3.3,
    y: 82.6,
    w: 29.4,
    h: 10.8,
...
export default function HomoHabilisScene() {
...
function GameFrame({
  ...
  const imageSrc =
    screen === "victory"
      ? "/assets/homo-habilis-victory.png"
      : screen === "fail"
        ? "/assets/homo-habilis-fail.png"
        : "/assets/homo-habilis-game.png";
  ...
  return (
    ...
    >
      <div className="relative aspect-[1792/1024] h-auto w-full max-h-screen max-w-screen overflow-hidden">
        <img
          src={imageSrc}
          alt="Desafío visual de Homo habilis"
