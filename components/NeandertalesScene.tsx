...
const choices: Choice[] = [
  {
    id: "compartir-abrigos",
    correct: true,
    label: "Compartir abrigo",
    x: 2.5,
    y: 65.9,
    w: 15.4,
    h: 13.6,
...
export default function NeandertalesScene() {
...
function GameFrame({
  ...
  const imageSrc =
    screen === "victory"
      ? "/assets/neandertales-victory.png"
      : screen === "fail"
        ? "/assets/neandertales-fail.png"
        : "/assets/neandertales-game.png";
  ...
  return (
    ...
    >
      <div className="relative aspect-[1792/1024] h-auto w-full max-h-screen max-w-screen overflow-hidden">
        <img
          src={imageSrc}
          alt="Desafío visual de Neandertales"
